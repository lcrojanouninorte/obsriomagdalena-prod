...
class MiscController extends Controller
{
    ...
    public function restartTileserver(){
        ...
        sleep(5);
        $ex["md"] = ' \n COMAND: docker  run --rm --name tileserver-gl -v "'.config('obs.TILESERVER_PATH').'":/createlab -p 8080:80 klokantech/tileserver-gl --verbose --config /createlab/tileserver-gl-config-colombia.json |at now \n' ;
